        ...
        customRequests.map((post) => (
          <Card key={post.$id} className="bg-card text-card-foreground shadow-md border-border">
            ...
            <CardContent className="p-4 pt-0 space-y-1">
              ...
              <p className="text-xs text-muted-foreground">Requested by: {post.providerName}</p>
              ...
              <Button
                ...
                onClick={() => toast.info(`Contacting ${post.providerName} at ${post.contact} to fulfill this request.`)}
              >
                Fulfill Request
              </Button>
            </CardContent>
