...
import { Loader2, User, Mail, Phone, Home, Briefcase, Calendar, DollarSign, Shield, Image as ImageIcon } from "lucide-react";
...
const ProfileDetailsPage = () => {
  ...
  const handleProfileUpdate = async (data: any) => {
    if (userProfile) {
      await updateUserProfile(data); // Pass only the data object
