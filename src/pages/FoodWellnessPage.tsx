...
const OFFERING_CATEGORIES = ["food-wellness"]; // Categories for direct offerings
...
const FoodWellnessPage = () => {
  ...
  // Filter posts into offerings and custom requests
            ...
            <Dialog open={isPostCustomOrderDialogOpen} onOpenChange={setIsPostCustomOrderDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[425px] bg-card text-card-foreground border-border">
                ...
                <PostServiceForm 
                  ...
                  showAmbassadorDelivery={false} // Ambassador delivery not applicable for requests
                />
              </DialogContent>
            </Dialog>
            <p className="text-xs text-destructive-foreground mt-4">
