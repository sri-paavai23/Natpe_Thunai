...
export const dummyProducts: Product[] = [ // Exported dummyProducts
  {
    ...
    title: "Advanced Calculus Textbook (Latest Edition)",
    price: "₹850",
    sellerRating: 4.9,
    sellerBadge: "Bookworm",
    type: "sell",
    description: "Required textbook for MA201. Excellent condition, no markings.",
    damages: "None.",
    policies: "Final sale, no returns.",
  ...
  },
  {
    ...
    sellerRating: 4.5,
    type: "rent",
    description: "High-definition portable projector, perfect for group study or presentations.",
    policies: "Return by midnight. ₹500 security deposit required.",
    condition: "Used - Good",
    sellerId: "userB",
  ...
  },
  {
    $id: "prod103",
    imageUrl: "/placeholder.svg",
    title: "Custom Digital Art Request (Logo/Avatar)",
    price: "₹300-₹600",
    sellerRating: 5.0,
    sellerBadge: "Artisan",
    type: "gift-request",
    description: "Looking for a digital artist to create a custom logo for my club.",
    referenceImageUrl: "https://example.com/logo_style.png",
    budget: "₹300-₹600",
  ...
  },
  {
    $id: "prod104",
    imageUrl: "/placeholder.svg",
    title: "Official Size 5 Football",
    price: "₹400",
    sellerRating: 4.7,
    type: "sports",
    description: "Durable football, slightly used but in great shape for practice.",
    condition: "Used - Good",
    sellerId: "userD",
    sellerName: "Arjun K.",
...
const MarketPage = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Start with dummy products
      let mergedProducts = dummyProducts.map(dummy => fetchedMap.get(dummy.$id) || dummy);
      
      // Add unique fetched products that weren't in dummy list
      response.documents.forEach(doc => {
        if (!mergedProducts.some(p => p.$id === doc.$id)) {
